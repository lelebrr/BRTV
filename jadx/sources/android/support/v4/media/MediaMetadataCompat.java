...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static {
        ...
        eVar.put(METADATA_KEY_ADVERTISEMENT, 0);
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            e eVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (eVar.containsKey(str) && ((Integer) eVar.get(str)).intValue() != 2) {
                throw new IllegalArgumentException(a.e.r("The ", str, " key cannot be used to put a Bitmap"));
            }
        ...
        public Builder putLong(String str, long j10) {
            ...
            if (eVar.containsKey(str) && ((Integer) eVar.get(str)).intValue() != 0) {
                throw new IllegalArgumentException(a.e.r("The ", str, " key cannot be used to put a long"));
            }
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            ...
            if (eVar.containsKey(str) && ((Integer) eVar.get(str)).intValue() != 3) {
                throw new IllegalArgumentException(a.e.r("The ", str, " key cannot be used to put a Rating"));
            }
        ...
        public Builder putString(String str, String str2) {
            ...
            if (eVar.containsKey(str) && ((Integer) eVar.get(str)).intValue() != 1) {
                throw new IllegalArgumentException(a.e.r("The ", str, " key cannot be used to put a String"));
            }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            e eVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (eVar.containsKey(str) && ((Integer) eVar.get(str)).intValue() != 1) {
                throw new IllegalArgumentException(a.e.r("The ", str, " key cannot be used to put a CharSequence"));
            }

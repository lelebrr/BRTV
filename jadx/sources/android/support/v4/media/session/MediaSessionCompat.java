...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((q) message.obj);
        ...
        public class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            private void setCurrentControllerInfo(MediaSessionImpl mediaSessionImpl) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(new q(callingPackage, -1, -1));
            }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        d session2Token = sessionToken.getSession2Token();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            q currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(q qVar);
        ...
        void setPlaybackToRemote(x xVar);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public MediaSessionImplApi18(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, d dVar, Bundle bundle) {
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        public MediaSessionImplApi19(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, d dVar, Bundle bundle) {
            super(context, str, componentName, pendingIntent, dVar, bundle);
        }
    ...
    public static class MediaSessionImplApi22 extends MediaSessionImplApi21 {
        public MediaSessionImplApi22(Context context, String str, d dVar, Bundle bundle) {
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        public MediaSessionImplApi28(Context context, String str, d dVar, Bundle bundle) {
            super(context, str, dVar, bundle);
        }
        ...
        public final q getCurrentControllerInfo() {
            ...
            qVar.f8147a = new r(currentControllerInfo.getPackageName(), currentControllerInfo.getPid(), currentControllerInfo.getUid());
            return qVar;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(q qVar) {
        }
    }

    /* compiled from: MyApplication */
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(Context context, String str, d dVar, Bundle bundle) {
            super(context, str, dVar, bundle);
        }
        ...
        public MediaSession createFwkMediaSession(Context context, String str, Bundle bundle) {
            return a0.a.d(context, str, bundle);
        }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            d dVarD = a2.a.D(bundle);
            Token token = (Token) bundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
            if (token == null) {
                return null;
            }
            return new Token(token.mInner, iMediaSessionAsInterface, dVarD);
        }
        ...
        public Bundle toBundle() {
            ...
            synchronized (this.mLock) {
                try {
                    ...
                    if (dVar != null) {
                        Bundle bundle2 = new Bundle();
                        bundle2.putParcelable(CmcdData.OBJECT_TYPE_AUDIO_ONLY, new ParcelImpl(dVar));
        ...
        public Token(Object obj, IMediaSession iMediaSession, d dVar) {
    ...
    public static MediaSessionCompat fromMediaSession(Context context, Object obj) {
        ...
        return new MediaSessionCompat(context, i6 >= 29 ? new MediaSessionImplApi29(obj) : i6 >= 28 ? new MediaSessionImplApi28(obj) : new MediaSessionImplApi21(obj));
    }
    ...
    public void setPlaybackToRemote(x xVar) {
        if (xVar == null) {
            throw new IllegalArgumentException("volumeProvider may not be null!");
        }
        this.mImpl.setPlaybackToRemote(xVar);
    }
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, d dVar) {
        this.mActiveListeners = new ArrayList<>();
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null) {
                    int i6 = MediaButtonReceiver.f2037a;
                ...
                if (i10 >= 29) {
                    this.mImpl = new MediaSessionImplApi29(context, str, dVar, bundle);
                } else if (i10 >= 28) {
                    this.mImpl = new MediaSessionImplApi28(context, str, dVar, bundle);
                } else if (i10 >= 22) {
                    this.mImpl = new MediaSessionImplApi22(context, str, dVar, bundle);
                } else {
                    this.mImpl = new MediaSessionImplApi21(context, str, dVar, bundle);
                }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public MediaSessionImplApi21(Context context, String str, d dVar, Bundle bundle) {
            ...
            this.mToken = new Token(mediaSessionCreateFwkMediaSession.getSessionToken(), new ExtraSession(), dVar);
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(x xVar) {
            this.mSessionFwk.setPlaybackToRemote(xVar.a());
        }
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new q("android.media.session.MediaController", callingPid, callingUid));
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        int mFlags = 3;
        private w mVolumeCallback = new w() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // m1.w
            public void onVolumeChanged(x xVar) {
                if (MediaSessionImplBase.this.mVolumeProvider != xVar) {
                    return;
                }
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, xVar.f8153a, xVar.f8154b, xVar.d));
            }
        };
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    x xVar = mediaSessionImplBase.mVolumeProvider;
                    i11 = 2;
                    if (i6 == 2) {
                        int i12 = xVar.f8153a;
                        int i13 = xVar.f8154b;
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                int callingPid = Binder.getCallingPid();
                int callingUid = Binder.getCallingUid();
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new q(MediaSessionImplBase.this.getPackageNameForUid(callingUid), callingPid, callingUid));
                synchronized (MediaSessionImplBase.this.mLock) {
                    try {
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new q(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, d dVar, Bundle bundle) {
            if (componentName == null) {
        ...
        public void adjustVolume(int i6, int i10) {
            ...
            x xVar = this.mVolumeProvider;
            if (xVar != null) {
                q1.d dVar = (q1.d) xVar;
                h hVar = dVar.f8948g.f8955c;
                hVar.f8986a.post(new c(i6, 1, dVar));
            }
        }
        ...
        public void setPlaybackToRemote(x xVar) {
            ...
            x xVar2 = this.mVolumeProvider;
            if (xVar2 != null) {
                xVar2.f8156e = null;
            }
            this.mVolumeType = 2;
            this.mVolumeProvider = xVar;
            int i6 = this.mVolumeType;
            int i10 = this.mLocalStream;
            x xVar3 = this.mVolumeProvider;
            sendVolumeInfoChanged(new ParcelableVolumeInfo(i6, i10, xVar3.f8153a, xVar3.f8154b, xVar3.d));
            xVar.f8156e = this.mVolumeCallback;
        }
        ...
        public void setVolumeTo(int i6, int i10) {
            ...
            if (xVar != null) {
                q1.d dVar = (q1.d) xVar;
                h hVar = dVar.f8948g.f8955c;
                hVar.f8986a.post(new c(i6, 0, dVar));
            }
        }

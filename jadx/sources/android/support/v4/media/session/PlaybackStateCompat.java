...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static class Api21Impl {
        ...
        public static PlaybackState.CustomAction.Builder createCustomActionBuilder(String str, CharSequence charSequence, int i6) {
        ...
        public static void setState(PlaybackState.Builder builder, int i6, long j10, float f, long j11) {
    ...
    public static final class Builder {
        ...
        public Builder addCustomAction(String str, String str2, int i6) {
        ...
        public Builder setState(int i6, long j10, float f) {
            return setState(i6, j10, f, SystemClock.elapsedRealtime());
        }
        ...
        public Builder setErrorMessage(int i6, CharSequence charSequence) {
            this.mErrorCode = i6;
            this.mErrorMessage = charSequence;
            return this;
        }

        public Builder setState(int i6, long j10, float f, long j11) {
            this.mState = i6;
            this.mPosition = j10;
    ...
    public PlaybackStateCompat(int i6, long j10, long j11, float f, long j12, int i10, CharSequence charSequence, long j13, List<CustomAction> list, long j14, Bundle bundle) {
        this.mState = i6;
        this.mPosition = j10;
    ...
    public String toString() {
        ...
        return e.s(sb, this.mActiveItemId, "}");
    }
    ...
    public void writeToParcel(Parcel parcel, int i6) {
        ...
        TextUtils.writeToParcel(this.mErrorMessage, parcel, i6);
    ...
    public static final class CustomAction implements Parcelable {
        ...
        public void writeToParcel(Parcel parcel, int i6) {
            ...
            TextUtils.writeToParcel(this.mName, parcel, i6);

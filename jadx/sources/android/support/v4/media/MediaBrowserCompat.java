...
public final class MediaBrowserCompat {
    ...
    public static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i6, Bundle bundle) {
            ...
            StringBuilder sbU = e.u(i6, "Unknown result code: ", " (extras=");
            sbU.append(this.mExtras);
            sbU.append(", resultData=");
            sbU.append(bundle);
            sbU.append(")");
            Log.w(MediaBrowserCompat.TAG, sbU.toString());
        }
    }
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        private final p.e mSubscriptions = new p.e(0);
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                StringBuilder sbW = e.w(str, " for ");
                sbW.append(MediaBrowserImplBase.this.mServiceComponent);
                sbW.append(" with mServiceConnection=");
                sbW.append(MediaBrowserImplBase.this.mServiceConnection);
                sbW.append(" this=");
                sbW.append(this);
                Log.i(MediaBrowserCompat.TAG, sbW.toString());
                return false;
            }
        ...
        private static String getStateLabel(int i6) {
            return i6 != 0 ? i6 != 1 ? i6 != 2 ? i6 != 3 ? i6 != 4 ? e.n(i6, "UNKNOWN/") : "CONNECT_STATE_SUSPENDED" : "CONNECT_STATE_CONNECTED" : "CONNECT_STATE_CONNECTING" : "CONNECT_STATE_DISCONNECTED" : "CONNECT_STATE_DISCONNECTING";
        }
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            ...
            StringBuilder sbW = e.w(str, " for ");
            sbW.append(this.mServiceComponent);
            sbW.append(" with mCallbacksMessenger=");
            sbW.append(this.mCallbacksMessenger);
            sbW.append(" this=");
            sbW.append(this);
            Log.i(MediaBrowserCompat.TAG, sbW.toString());
            return false;
        ...
        public void connect() {
            int i6 = this.mState;
            if (i6 != 0 && i6 != 1) {
                throw new IllegalStateException(e.t(new StringBuilder("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
            }
            this.mState = 2;
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(e.t(new StringBuilder("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(e.t(new StringBuilder("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public void onServiceConnected(Messenger messenger, String str, MediaSessionCompat.Token token, Bundle bundle) {
            if (isCurrent(messenger, "onConnect")) {
                ...
                try {
                    Iterator it = ((g0) this.mSubscriptions.entrySet()).iterator();
                    while (it.hasNext()) {
        ...
        public void search(final String str, final Bundle bundle, final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException(e.t(new StringBuilder("search() called while not connected (state="), getStateLabel(this.mState), ")"));
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException e5) {
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i6 = 0; i6 < this.mOptionsList.size(); i6++) {
                if (c.b(this.mOptionsList.get(i6), bundle)) {

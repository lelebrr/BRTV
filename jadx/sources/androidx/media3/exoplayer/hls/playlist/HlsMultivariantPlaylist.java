...
public final class HlsMultivariantPlaylist extends HlsPlaylist {
    ...
    public HlsMultivariantPlaylist(String str, List<String> list, List<Variant> list2, List<Rendition> list3, List<Rendition> list4, List<Rendition> list5, List<Rendition> list6, Format format, List<Format> list7, boolean z7, Map<String, String> map, List<DrmInitData> list8) {
        super(str, list, z7);
    ...
    private static <T> List<T> copyStreams(List<T> list, int i6, List<StreamKey> list2) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            while (true) {
                if (i11 < list2.size()) {
                    ...
                    if (streamKey.groupIndex == i6 && streamKey.streamIndex == i10) {
                        arrayList.add(t5);
                        break;
                    }
                    i11++;

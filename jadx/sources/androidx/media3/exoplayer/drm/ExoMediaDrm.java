...
public interface ExoMediaDrm {
    ...
    public interface OnEventListener {
        void onEvent(ExoMediaDrm exoMediaDrm, byte[] bArr, int i6, int i10, byte[] bArr2);
    }
    ...
    KeyRequest getKeyRequest(byte[] bArr, List<DrmInitData.SchemeData> list, int i6, HashMap<String, String> map) throws NotProvisionedException;

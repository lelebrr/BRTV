...
public final class PgsParser implements SubtitleParser {
    ...
    public static final class CueBuilder {
        ...
        public void parseBitmapSection(ParsableByteArray parsableByteArray, int i6) {
            int unsignedInt24;
            if (i6 < 4) {
                return;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void parseIdentifierSection(ParsableByteArray parsableByteArray, int i6) {
            if (i6 < 19) {
                return;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i6) {
            if (i6 % 5 != 2) {
                return;
            }
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                this.colors[unsignedByte] = (Util.constrainValue((int) ((d - (0.34414d * d11)) - (d10 * 0.71414d)), 0, 255) << 8) | (parsableByteArray.readUnsignedByte() << 24) | (Util.constrainValue((int) ((1.402d * d10) + d), 0, 255) << 16) | Util.constrainValue((int) ((d11 * 1.772d) + d), 0, 255);
            }
            this.colorsSet = true;
        }
    ...
    public void parse(byte[] bArr, int i6, int i10, SubtitleParser.OutputOptions outputOptions, Consumer<CuesWithTiming> consumer) {
        this.buffer.reset(bArr, i10 + i6);
        this.buffer.setPosition(i6);

...
public final class DefaultDataSource implements DataSource {
    ...
    private void addListenersToDataSource(DataSource dataSource) {
        for (int i6 = 0; i6 < this.transferListeners.size(); i6++) {
            dataSource.addTransferListener(this.transferListeners.get(i6));
        }
    }
    ...
    public int read(byte[] bArr, int i6, int i10) throws IOException {
        return ((DataSource) Assertions.checkNotNull(this.dataSource)).read(bArr, i6, i10);
    }

    @UnstableApi
    public DefaultDataSource(Context context, String str, boolean z7) {
        this(context, str, 8000, 8000, z7);
    }

    @UnstableApi
    public DefaultDataSource(Context context, String str, int i6, int i10, boolean z7) {
        this(context, new DefaultHttpDataSource.Factory().setUserAgent(str).setConnectTimeoutMs(i6).setReadTimeoutMs(i10).setAllowCrossProtocolRedirects(z7).createDataSource());
    }

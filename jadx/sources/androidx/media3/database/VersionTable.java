...
public final class VersionTable {
    ...
    private static String[] featureAndInstanceUidArguments(int i6, String str) {
        return new String[]{Integer.toString(i6), str};
    }

    public static int getVersion(SQLiteDatabase sQLiteDatabase, int i6, String str) throws DatabaseIOException {
        try {
            if (!Util.tableExists(sQLiteDatabase, TABLE_NAME)) {
                return -1;
            }
            Cursor cursorQuery = sQLiteDatabase.query(TABLE_NAME, new String[]{COLUMN_VERSION}, WHERE_FEATURE_AND_INSTANCE_UID_EQUALS, featureAndInstanceUidArguments(i6, str), null, null, null);
            try {
    ...
    public static void removeVersion(SQLiteDatabase sQLiteDatabase, int i6, String str) throws DatabaseIOException {
        try {
            if (Util.tableExists(sQLiteDatabase, TABLE_NAME)) {
                sQLiteDatabase.delete(TABLE_NAME, WHERE_FEATURE_AND_INSTANCE_UID_EQUALS, featureAndInstanceUidArguments(i6, str));
            }
        } catch (SQLException e5) {
            throw new DatabaseIOException(e5);
        }
    ...
    public static void setVersion(SQLiteDatabase sQLiteDatabase, int i6, String str, int i10) throws DatabaseIOException, SQLException {
        try {
            sQLiteDatabase.execSQL(SQL_CREATE_TABLE_IF_NOT_EXISTS);
            ContentValues contentValues = new ContentValues();
            contentValues.put(COLUMN_FEATURE, Integer.valueOf(i6));

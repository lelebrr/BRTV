...
public final class Cue {
    ...
    public static final class Builder {
        ...
        public Builder setLine(float f, int i6) {
            this.line = f;
            this.lineType = i6;
            return this;
        }

        public Builder setLineAnchor(int i6) {
            this.lineAnchor = i6;
            return this;
        }
        ...
        public Builder setPositionAnchor(int i6) {
        ...
        public Builder setTextSize(float f, int i6) {
            this.textSize = f;
        ...
        public Builder setWindowColor(int i6) {
            this.windowColor = i6;
    ...
    private Cue(CharSequence charSequence, Layout.Alignment alignment, Layout.Alignment alignment2, Bitmap bitmap, float f, int i6, int i10, float f3, int i11, int i12, float f4, float f5, float f10, boolean z7, int i13, int i14, float f11) {
        if (charSequence == null) {

...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                ...
                this.hashCode = Arrays.hashCode(this.data) + a.e.h((iHashCode + (str == null ? 0 : str.hashCode())) * 31, 31, this.mimeType);
            }
    ...
    private static boolean containsSchemeDataWithUuid(ArrayList<SchemeData> arrayList, int i6, UUID uuid) {
    ...
    public SchemeData get(int i6) {
        return this.schemeDatas[i6];
    }

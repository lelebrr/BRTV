...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z7) {
        ...
        if (this.cipherSuitesAsString != null) {
            ...
            i.e(enabledCipherSuites2, "sslSocket.enabledCipherSuites");
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            enabledProtocols = Util.intersect(enabledProtocols2, this.tlsVersionsAsString, a.f11672b);
        } else {
        ...
        if (z7 && iIndexOf != -1) {
            i.e(enabledCipherSuites, "cipherSuitesIntersection");
        ...
        i.e(enabledProtocols, "tlsVersionsIntersection");
        return builderCipherSuites.tlsVersions((String[]) Arrays.copyOf(enabledProtocols, enabledProtocols.length)).build();
    }

    /* renamed from: -deprecated_cipherSuites, reason: not valid java name */
    public final List<CipherSuite> m31deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* renamed from: -deprecated_supportsTlsExtensions, reason: not valid java name */
    public final boolean m32deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    /* renamed from: -deprecated_tlsVersions, reason: not valid java name */
    public final List<TlsVersion> m33deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), a.f11672b)) {
            return false;
        }
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuiteArr) {
            i.f(cipherSuiteArr, "cipherSuites");
            if (!this.tls) {
                throw new IllegalArgumentException("no cipher suites for cleartext connections");
            }

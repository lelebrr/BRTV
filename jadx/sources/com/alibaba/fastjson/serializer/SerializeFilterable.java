...
public abstract class SerializeFilterable {
    ...
    public Object processValue(JSONSerializer jSONSerializer, BeanContext beanContext, Object obj, String str, Object obj2, int i6) {
        boolean z7;
        if (obj2 != null) {
            int i10 = jSONSerializer.out.features;
            SerializerFeature serializerFeature = SerializerFeature.WriteNonStringValueAsString;
            if ((SerializerFeature.isEnabled(i10, i6, serializerFeature) || !(beanContext == null || (beanContext.getFeatures() & serializerFeature.mask) == 0)) && (((z7 = obj2 instanceof Number)) || (obj2 instanceof Boolean))) {
                String format = (!z7 || beanContext == null) ? null : beanContext.getFormat();

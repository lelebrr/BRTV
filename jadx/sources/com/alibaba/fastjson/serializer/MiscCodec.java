...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    /* JADX WARN: Type inference failed for: r12v39, types: [T, java.text.DateFormat, java.text.SimpleDateFormat] */
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i6) throws TransformerException, IOException {
        String string;
            ...
            if (obj instanceof File) {
                ...
                if (obj.getClass().getName().equals("net.sf.json.JSONNull")) {
                    ...
                    if (!(obj instanceof Node)) {
                        throw new JSONException(e.q(cls, "not support class : "));
                    }

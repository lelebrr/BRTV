...
public final class aa {
    ...
    public List<String> f5589v;
    public boolean f = true;

    /* renamed from: g, reason: collision with root package name */
    public final String f5574g = "com.tencent.bugly";

    /* renamed from: h, reason: collision with root package name */
    public String f5575h = "4.1.9.3";
    ...
    public String f5579l = "unknown";
    private String ab = "unknown";
    private String ac = "";

    /* renamed from: m, reason: collision with root package name */
    public long f5580m = 0;
    ...
    public boolean f5581n = false;
    private String al = null;
    private Boolean am = null;
    private String an = null;

    /* renamed from: t, reason: collision with root package name */
    public String f5587t = null;

    /* renamed from: u, reason: collision with root package name */
    public String f5588u = null;
    ...
    public String f5592y = "unknown";

    /* renamed from: z, reason: collision with root package name */
    public long f5593z = 0;
    public long A = 0;
    public long B = 0;
    public long C = 0;
    ...
    public final long f5569a = System.currentTimeMillis();

    /* renamed from: b, reason: collision with root package name */
    public final byte f5571b = 1;
    ...
    private aa(Context context) {
        ...
        this.f5572c = z.a(context);
        this.d = z.a(Process.myPid());
        this.f5584q = z.c(context);
        this.f5578k = "Android " + ab.b() + ",level " + ab.c();
        Map<String, String> mapD = z.d(context);
        if (mapD != null) {
            try {
                this.f5589v = z.a(mapD);
                ...
                if (!TextUtils.isEmpty(str7)) {
                    this.f5583p = Integer.parseInt(str7);
                }
    ...
    public final boolean a() {
        boolean z7 = this.ay.size() > 0;
        al.c("isAppForeground:%s", Boolean.valueOf(z7));
        return z7;
    }
    ...
    public final String e() {
        return !ap.b(this.f5573e) ? this.f5573e : this.f5585r;
    }
    ...
    public final void a(int i6, boolean z7) {
        al.c("setActivityForeState, hash:%s isFore:%s", Integer.valueOf(i6), Boolean.valueOf(z7));
        if (z7) {
            this.ay.add(Integer.valueOf(i6));
        } else {
            this.ay.remove(Integer.valueOf(i6));
    ...
    private void a(String str, String str2, boolean z7) {
        ...
        al.c("putExtraRequestData key:%s value:%s save:%s", str, str2, Boolean.valueOf(z7));
        synchronized (this.ax) {
            try {

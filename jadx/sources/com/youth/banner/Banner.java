...
public class Banner<T, BA extends BannerAdapter<T, ? extends p1>> extends FrameLayout implements BannerLifecycleObserver {
    ...
    private BA mAdapter;
    private final m0 mAdapterDataObserver;
    ...
    public Banner addBannerLifecycleObserver(w wVar) {
        if (wVar != null) {
            wVar.f().a(new BannerLifecycleObserverAdapter(wVar, this));
        }
        return this;
    }

    public Banner addItemDecoration(t0 t0Var) {
        getViewPager2().addItemDecoration(t0Var);
        return this;
    }
    ...
    */
    ...
    public Banner setIndicatorNormalColorRes(int i6) {
        setIndicatorNormalColor(d.i(getContext(), i6));
        return this;
    }
    ...
    public Banner setIndicatorSelectedColorRes(int i6) {
        setIndicatorSelectedColor(d.i(getContext(), i6));
        return this;
    }
    ...
    public Banner addItemDecoration(t0 t0Var, int i6) {
        getViewPager2().addItemDecoration(t0Var, i6);
        return this;
    }
    ...
    public Banner(Context context, AttributeSet attributeSet, int i6) {
        ...
        this.mAdapterDataObserver = new m0() { // from class: com.youth.banner.Banner.1

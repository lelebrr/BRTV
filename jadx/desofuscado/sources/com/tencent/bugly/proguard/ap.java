...
public final class ap {
    ...
    private static Map<String, String> f5672a;
    ...
    public static void b(long j10) throws InterruptedException {
        try {
            Thread.sleep(j10);
    ...
    public static String a(String str) {
        ...
        try {
            ...
            if (f5672a.containsKey(str)) {
                return f5672a.get(str);
            }
    ...
    public static void a(Parcel parcel, Map<String, PlugInBean> map) {
        if (map != null && map.size() > 0) {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                bundle.putString(ea.q.f(i10, "pluginVal", "plugInId"), ((PlugInBean) arrayList2.get(i10)).f5495a);
                bundle.putString("pluginVal" + i10 + "plugInUUID", ((PlugInBean) arrayList2.get(i10)).f5497c);
                bundle.putString("pluginVal" + i10 + "plugInVersion", ((PlugInBean) arrayList2.get(i10)).f5496b);
            }
            parcel.writeBundle(bundle);
            return;
        }
    ...
    public static String a(int i6, String str) throws IOException {
        String[] strArr;
        if (str == null) {
    ...
    public static Map<String, String> a(boolean z7, int i6) {
        if (!z7) {
            al.c("get all thread stack not enable", new Object[0]);
            return new HashMap();
        }
        Map<String, String> mapA = a(i6);
        return mapA == null ? new HashMap() : mapA;
    }

    private static Map<String, String> a(int i6) {
    ...
    public static String a(File file, int i6, boolean z7) throws IOException {

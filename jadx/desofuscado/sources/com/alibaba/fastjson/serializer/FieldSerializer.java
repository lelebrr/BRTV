...
public class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    public FieldSerializer(Class<?> cls, FieldInfo fieldInfo) throws SecurityException {
        ...
        this.double_quoted_fieldPrefix = e.t(new StringBuilder("\""), fieldInfo.name, "\":");
    ...
    public void writePrefix(JSONSerializer jSONSerializer) throws IOException {
        ...
        if (!serializeWriter.quoteFieldNames) {
            if (this.un_quoted_fieldPrefix == null) {
                this.un_quoted_fieldPrefix = e.t(new StringBuilder(), this.fieldInfo.name, ":");
            }
            ...
            if (this.single_quoted_fieldPrefix == null) {
                this.single_quoted_fieldPrefix = e.t(new StringBuilder("'"), this.fieldInfo.name, "':");
            }

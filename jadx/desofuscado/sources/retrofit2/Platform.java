...
class Platform {
    ...
    public Platform(boolean z7) throws NoSuchMethodException, SecurityException {
        this.hasJava8Types = z7;
        Constructor<MethodHandles.Lookup> declaredConstructor = null;
        if (z7) {
            try {
                declaredConstructor = f.f().getDeclaredConstructor(Class.class, Integer.TYPE);
    ...
    public Object invokeDefaultMethod(Method method, Class<?> cls, Object obj, Object... objArr) throws Throwable {
        ...
        return (constructor != null ? f.k(constructor.newInstance(cls, -1)) : MethodHandles.lookup()).unreflectSpecial(method, cls).bindTo(obj).invokeWithArguments(objArr);
    }

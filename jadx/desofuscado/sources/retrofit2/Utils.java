...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return e.t(new StringBuilder(), Utils.typeToString(this.componentType), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            for (int i6 = 1; i6 < this.typeArguments.length; i6++) {
                sb.append(", ");
                sb.append(Utils.typeToString(this.typeArguments[i6]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static Type getParameterLowerBound(int i6, ParameterizedType parameterizedType) {
    ...
    public static Type getParameterUpperBound(int i6, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbU = e.u(i6, "Index ", " not in range [0,");
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i6, String str, Object... objArr) {
        StringBuilder sbW = e.w(str, " (parameter #");
        sbW.append(i6 + 1);
        sbW.append(")");
        return methodError(method, th, sbW.toString(), objArr);
    }
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if (type3 instanceof ParameterizedType) {
            ...
            boolean z7 = typeResolve3 != ownerType;
            Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
            int length = actualTypeArguments.length;
            for (int i6 = 0; i6 < length; i6++) {
                Type typeResolve4 = resolve(type, cls, actualTypeArguments[i6]);
                if (typeResolve4 != actualTypeArguments[i6]) {
                    if (!z7) {
                        actualTypeArguments = (Type[]) actualTypeArguments.clone();
                        z7 = true;
                    }
                    actualTypeArguments[i6] = typeResolve4;
                }
            }
            return z7 ? new ParameterizedTypeImpl(typeResolve3, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
        }
        boolean z10 = type3 instanceof WildcardType;
        Type type4 = type3;
        if (z10) {
    ...
    public static RuntimeException methodError(Method method, Throwable th, String str, Object... objArr) {
        StringBuilder sbW = e.w(String.format(str, objArr), "\n    for method ");
        sbW.append(method.getDeclaringClass().getSimpleName());
        sbW.append(".");
        sbW.append(method.getName());
        return new IllegalArgumentException(sbW.toString(), th);
    }

    public static RuntimeException parameterError(Method method, int i6, String str, Object... objArr) {
        StringBuilder sbW = e.w(str, " (parameter #");
        sbW.append(i6 + 1);
        sbW.append(")");
        return methodError(method, sbW.toString(), objArr);
    }
}

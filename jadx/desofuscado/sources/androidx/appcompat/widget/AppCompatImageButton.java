...
public class AppCompatImageButton extends ImageButton {
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f509b.f907b).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        z zVar = this.f509b;
        if (zVar != null && drawable != null && !this.f510c) {

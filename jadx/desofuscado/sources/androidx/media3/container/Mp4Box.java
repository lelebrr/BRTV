...
public abstract class Mp4Box {
    ...
    public static final class ContainerBox extends Mp4Box {
        ...
        public ContainerBox(int i6, long j10) {
            super(i6);
        ...
        public ContainerBox getContainerBoxOfType(int i6) {
            int size = this.containerChildren.size();
            for (int i10 = 0; i10 < size; i10++) {
                ContainerBox containerBox = this.containerChildren.get(i10);
                if (containerBox.type == i6) {
                    return containerBox;
                }
            }
            return null;
        ...
        public LeafBox getLeafBoxOfType(int i6) {
            int size = this.leafChildren.size();
            for (int i10 = 0; i10 < size; i10++) {
                LeafBox leafBox = this.leafChildren.get(i10);
                if (leafBox.type == i6) {
                    return leafBox;
                }
            }
    ...
    public static final class LeafBox extends Mp4Box {
        ...
        public LeafBox(int i6, ParsableByteArray parsableByteArray) {
            super(i6);
            this.data = parsableByteArray;
        }
    }

    public static String getBoxTypeString(int i6) {

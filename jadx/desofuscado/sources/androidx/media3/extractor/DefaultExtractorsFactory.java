...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
    ...
    private static final ExtensionLoader FLAC_EXTENSION_LOADER = new ExtensionLoader(new s(6));
    private static final ExtensionLoader MIDI_EXTENSION_LOADER = new ExtensionLoader(new s(7));
        ...
        switch (i6) {
            ...
            case 11:
                if (this.tsSubtitleFormats == null) {
                    g1 g1Var = u1.f6276b;
                    this.tsSubtitleFormats = c5.f6115e;
                }
    ...
    public synchronized DefaultExtractorsFactory setTsSubtitleFormats(List<Format> list) {
        this.tsSubtitleFormats = u1.n(list);
        return this;
    }

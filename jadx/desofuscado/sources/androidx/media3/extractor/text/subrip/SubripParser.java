...
public final class SubripParser implements SubtitleParser {
    ...
    */
    ...
    @Override // androidx.media3.extractor.text.SubtitleParser
    public void parse(byte[] bArr, int i6, int i10, SubtitleParser.OutputOptions outputOptions, Consumer<CuesWithTiming> consumer) throws NumberFormatException {
        String str;
        ...
        while (true) {
            ...
            if (line2.length() != 0) {
                try {
                    ...
                    str = str4;
                    consumer2 = consumer4;
                    Log.w(str, "Skipping invalid index: ".concat(line2));
                }
                if (line == null) {
                ...
                if (matcher.matches()) {
                    ...
                    if (j10 == C.TIME_UNSET || timecode >= j10) {
                        consumer3 = consumer;
                        consumer3.accept(new CuesWithTiming(u1.r(buildCue(spannedFromHtml, str3)), timecode, timecode2 - timecode));
                    } else {
                        if (arrayList != null) {
                            arrayList.add(new CuesWithTiming(u1.r(buildCue(spannedFromHtml, str3)), timecode, timecode2 - timecode));
                        }
                        consumer3 = consumer;
                    }
                    consumer4 = consumer3;
                    ...
                    consumer2 = consumer4;
                    str = str5;
                    Log.w(str, "Skipping invalid timing: ".concat(line));
                    consumer4 = consumer2;
                    str4 = str;
                }
            }

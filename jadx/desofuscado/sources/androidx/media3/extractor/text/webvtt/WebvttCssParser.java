...
final class WebvttCssParser {
    ...
    private static void parseFontSize(String str, WebvttCssStyle webvttCssStyle) {
        Matcher matcher = FONT_SIZE_PATTERN.matcher(b.v(str));
        if (!matcher.matches()) {
    ...
    private static char peekCharAtPosition(ParsableByteArray parsableByteArray, int i6) {
        return (char) parsableByteArray.getData()[i6];
    }

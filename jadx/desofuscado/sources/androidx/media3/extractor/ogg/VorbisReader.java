...
final class VorbisReader extends StreamReader {
    ...
    public static int readBits(byte b8, int i6, int i10) {
        return (b8 >> i10) & (255 >>> (8 - i6));
    }

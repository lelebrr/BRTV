...
public final class LatmReader implements ElementaryStreamReader {
    ...
    public LatmReader(String str, int i6, String str2) {
        this.language = str;
        this.roleFlags = i6;
    ...
    private void parsePayloadMux(ParsableBitArray parsableBitArray, int i6) {
        int position = parsableBitArray.getPosition();
        if ((position & 7) == 0) {
            this.sampleDataBuffer.setPosition(position >> 3);
        } else {
            parsableBitArray.readBits(this.sampleDataBuffer.getData(), 0, i6 * 8);
            this.sampleDataBuffer.setPosition(0);
        }
        this.output.sampleData(this.sampleDataBuffer, i6);
        Assertions.checkState(this.timeUs != C.TIME_UNSET);
        this.output.sampleMetadata(this.timeUs, 1, i6, 0, null);
    ...
    private void resetBufferForSize(int i6) {
        this.sampleDataBuffer.reset(i6);

...
public interface DrmSessionEventListener {
    ...
    public static class EventDispatcher {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$drmSessionAcquired$0(DrmSessionEventListener drmSessionEventListener, int i6) {
        ...
        public void drmKeysLoaded() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new g(this, next.listener, 2));
            }
        }
        ...
        public void drmKeysRemoved() {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                Util.postOrRun(next.handler, new g(this, next.listener, 0));
            }
        }
        ...
        public void drmKeysRestored() {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                Util.postOrRun(next.handler, new g(this, next.listener, 1));
            }
        }
        ...
        public void drmSessionAcquired(int i6) {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                Util.postOrRun(next.handler, new androidx.media3.common.util.d(this, next.listener, i6));
            }
        }
        ...
        public void drmSessionManagerError(Exception exc) {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                Util.postOrRun(next.handler, new androidx.media3.common.util.i(this, next.listener, exc, 3));
            }
        }
        ...
        public void drmSessionReleased() {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                Util.postOrRun(next.handler, new g(this, next.listener, 3));
            }
        }

...
public interface Renderer extends PlayerMessage.Target {
    ...
    void enable(RendererConfiguration rendererConfiguration, Format[] formatArr, SampleStream sampleStream, long j10, boolean z7, boolean z10, long j11, long j12, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException;
    ...
    void init(int i6, PlayerId playerId, Clock clock);
    ...
    void setPlaybackSpeed(float f, float f3) throws ExoPlaybackException;

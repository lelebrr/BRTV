...
public final class MediaParserExtractorAdapter implements ProgressiveMediaExtractor {
    ...
    @Deprecated
    public static final ProgressiveMediaExtractor.Factory FACTORY = new p(2);
    ...
    public static /* synthetic */ ProgressiveMediaExtractor lambda$static$0(PlayerId playerId) {
        return new MediaParserExtractorAdapter(playerId, h5.f6165g);
    }
    ...
    public void seek(long j10, long j11) {
        ...
        this.mediaParser.seek(androidx.media3.exoplayer.hls.j.l(androidx.media3.exoplayer.hls.j.l(seekPoints.second).position == j10 ? seekPoints.second : seekPoints.first));
    }

    @Deprecated
    public MediaParserExtractorAdapter(PlayerId playerId) {
        this(playerId, h5.f6165g);
    }
